...
[下载游戏数据资源包（ZIP，1352 个 JSON 文件）](/resources/game-json-0.14.0.zip)

包含本体中的 Features、Objects、关卡、语言等数据，可用于查询字段、制作补丁或在关卡编辑器中导入单个关卡。资源包不是可直接安装的数据包；需要查看当前模组修改后的数据时，请使用下方的导出方法。
